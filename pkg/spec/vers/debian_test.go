...
func TestContains_Debian(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			versRange: "vers:deb/>=1.0.0|<=2.0.0",
			version:   "1.5.0",
			want:      true,
			wantErr:   false,
		},
		{
			...
			versRange: "vers:deb/>=2.0.0|<=3.0.0",
			version:   "1.0.0",
			want:      false,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:deb/>=1.0.0|<=2.0.0|!=1.5.0",
			version:   "1.2.0",
			want:      true,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:deb/>=1:2.4.1|<1:3.0.0",
			version:   "1:2.5.0",
			want:      true,
			wantErr:   false,
		},
		{
			...
			versRange: "vers:deb/>=2:1.0.0|<=2:2.0.0",
			version:   "1:5.0.0",
			want:      false,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:deb/>=2.4.1-1ubuntu1|<2.4.2",
		...
		},
		{
			...
			versRange: "vers:deb/>=1:2.4.1-1|<1:3.0.0-1",
			version:   "1:2.5.0-2",
			want:      true,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:deb/>=1:2.4.1-1|<=1:3.0.0-1|!=1:2.5.0-1",
			version:   "1:2.6.0-1",
			want:      true,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:deb/>=1.0.0@invalid",
			version:   "1.0.0",
			want:      false,
			wantErr:   true,
		},
