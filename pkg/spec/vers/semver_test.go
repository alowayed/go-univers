...
func TestContains_SemVer(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			versRange: "vers:generic/>=1.0.0|<=2.0.0",
			version:   "1.5.0",
			want:      true,
			wantErr:   false,
		},
		{
			...
			versRange: "vers:generic/>=2.0.0|<=3.0.0",
			version:   "1.0.0",
			want:      false,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:generic/>=1.0.0|<=2.0.0|!=1.5.0",
			version:   "1.2.0",
			want:      true,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:generic/>=1.0.0-alpha.1",
		...
		},
		{
			...
			versRange: "vers:generic/>=1.0.0-alpha.1|<2.0.0",
			version:   "1.5.0",
			want:      true,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:generic/>=1.0.0-alpha.5|<2.0.0",
			version:   "1.0.0-alpha.1",
			want:      false,
			wantErr:   false,
		},
		{
			...
			versRange: "vers:generic/>=1.0.0+build123",
		...
		},
		{
			...
			versRange: "vers:generic/>=1.0.0+build123|<2.0.0",
			version:   "1.5.0+other",
			want:      true,
			wantErr:   false,
		},
		{
			...
			versRange: "vers:generic/>=1.0.0-alpha.1+build|<2.0.0",
		...
		},
		{
			...
			versRange: "vers:generic/>=1.0.0-alpha|<=2.0.0-beta+build",
			version:   "1.5.0",
			want:      true,
			wantErr:   false,
		},
		...
		},
		{
			...
			versRange: "vers:generic/>=invalid",
			version:   "1.0.0",
			want:      false,
			wantErr:   true,
		},
